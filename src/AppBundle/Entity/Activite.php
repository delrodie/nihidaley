...
class Activite
{
     ...
     * @var string
     *
     * @ORM\Column(name="heuredeb", type="string", length=255, nullable=true)
     */
    private $heuredeb;
     ...
     * @var string
     *
     * @ORM\Column(name="heurefin", type="string", length=255, nullable=true)
     */
    private $heurefin;
     ...
     * Set lieu
     *
     * @param \AppBundle\Entity\Site $lieu
     *
     * @return Activite
     */
    public function setLieu(\AppBundle\Entity\Site $lieu = null)
    {
        $this->lieu = $lieu;
