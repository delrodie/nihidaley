 ...
 * GaleriePhoto
 *
 * @ORM\Table(name="galerie_photo")
 * @ORM\Entity(repositoryClass="AppBundle\Repository\GaleriePhotoRepository")
 * @Vich\Uploadable
 */
class GaleriePhoto
{
     ...
     * Set album
     *
     * @param \AppBundle\Entity\Galerie $album
     *
     * @return GaleriePhoto
     */
    public function setAlbum(\AppBundle\Entity\Galerie $album = null)
    {
        $this->album = $album;
