...
class SiteController extends Controller
{
     ...
     *
     * @Route("/new", name="backend_site_new")
     * @Method({"GET", "POST"})
     */
    public function newAction(Request $request)
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('backend_site_show', array('id' => $site->getId()));
        }
     ...
     *
     * @Route("/{id}", name="backend_site_show")
     * @Method("GET")
     */
     ...
     *
     * @Route("/{slug}/edit", name="backend_site_edit")
     * @Method({"GET", "POST"})
     */
     ...
     *
     * @Route("/{id}", name="backend_site_delete")
     * @Method("DELETE")
     */
    ...
    private function createDeleteForm(Site $site)
    {
        return $this->createFormBuilder()
            ->setAction($this->generateUrl('backend_site_delete', array('id' => $site->getId())))
            ->setMethod('DELETE')
            ->getForm()
        ;
    }
